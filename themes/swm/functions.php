 ...
 */
function swm_minified_css($stylesheet_uri, $stylesheet_dir_uri)
{
...
add_filter('stylesheet_uri', 'swm_minified_css', 10, 2);

/**
 * Enqueue scripts and styles.
 */

function swm_customs_scripts()
{
	...
	wp_enqueue_script('swm-skip-link-focus-fix', get_template_directory_uri() . '/build/js/skip-link-focus-fix.min.js', array(), '20151215', true);
	// wp_localize_script('swm_main_script', 'global_vars', array(
...
add_action('wp_enqueue_scripts', 'swm_customs_scripts');
...
add_action('wp_enqueue_scripts', 'swm_external_css');
